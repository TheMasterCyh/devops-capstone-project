...
# Use HTTPS with the Flask test client for Talisman security tests
...
class TestAccountService(TestCase):
    ...
    def test_list_all_accounts(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.get_json()), account_count)

    def test_list_all_accounts_empty(self):
        """List: It should return an empty list when no Accounts exist"""
        response = self.client.get(BASE_URL)
    ...
    def test_update_an_account(self):
        """Update: It should Update an existing Account"""
        account = self._create_accounts(1)[0]
        ...
        self.assertEqual(updated_account["name"], "Updated Customer")

    def test_update_account_not_found(self):
        """Update: It should return 404 when Account does not exist"""
        account = AccountFactory()
    ...
    def test_delete_an_account(self):
        """Delete: It should Delete an existing Account"""
        account = self._create_accounts(1)[0]
    ...
    def test_delete_account_not_found(self):
        """Delete: It should return 404 when Account does not exist"""
